...
insert into public.site_settings (key, value, type, group_name, label, description) values
  ...
  ('home.secondary_button_speakers', 'Ponentes', 'text', 'Inicio', 'Botón ponentes', 'Texto del acceso rápido a ponentes.'),
  ...
  ('speakers.title', 'Ponentes', 'text', 'Ponentes', 'Título', 'Título de la vista Ponentes.'),
  ('speakers.description', 'Equipo docente y coordinación según la información disponible en los materiales.', 'textarea', 'Ponentes', 'Descripción', 'Descripción breve de ponentes.'),
  ...
  ('contact.coordination_value', 'Julio Fernando Ospino Arias, Guillermo José Olivero Sanjuanelo y Kelly Esther Escorcia Reyes', 'textarea', 'Contacto', 'Coordinación', 'Texto de coordinación.'),
